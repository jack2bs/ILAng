...
void registerAllModels(PPA_Registrar & registrar)
{
    ...
    constProf_ptr ander_32b { 
        std::make_shared<constProf>(0.06, 1.807256e-03, 6.111633e-04, 5.036996e+01, 32, -1, false)
    };

    constProf_ptr shifter_32b {
        std::make_shared<constProf>(0.70, 4.150581e-02, 1.695100e-03, 2.496461e+02, 32, 2, true)
    };

    constProf_ptr adder_32b {
        std::make_shared<constProf>(1.75, 8.534078e-03, 2.380803e-03, 1.794430e+02, 32, 4, true)
    };

    constProf_ptr multiplier_32b {
        std::make_shared<constProf>(4.9, 8.796144e-01, 4.817683e-02, 4.595000e+03, 32, 2, true)
    };

    constProf_ptr registerHold_32b {
        std::make_shared<constProf>(0, 0, 7.358945e-05, 5.981433e+00, 32, INT_MAX, true)
    };

    constProf_ptr registerRead_32b {
        std::make_shared<constProf>(0, 5.535310e-04, 0, 0, 32, INT_MAX, true)
    };

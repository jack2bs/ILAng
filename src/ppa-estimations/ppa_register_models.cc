...
void registerAllModels(PPA_Registrar & registrar)
{
    ...
    constProf_ptr shifter_32b {
        std::make_shared<constProf>(74, 17331.483, 2270.682, 64.684, 32, 2, true)
    };

    constProf_ptr adder_32b {
        std::make_shared<constProf>(302, 6711.251, 942.731, 36.913, 32, 16, true)
    };

    constProf_ptr divider_32b {
        std::make_shared<constProf>(5356, 189528.282, 26600.057, 804.422, 32, 2, true)
    };

    constProf_ptr multiplier_32b {
         std::make_shared<constProf>(355, 228240.874, 17879.126, 509.903, 32, 2, true)
    };

    constProf_ptr remainder_32b { 
        std::make_shared<constProf>(5612, 203004.908, 27450.345, 833.176, 32, 2, true)
    };
